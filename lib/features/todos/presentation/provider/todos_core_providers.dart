...
part 'todos_core_providers.g.dart';
...
@Riverpod(keepAlive: true)
GetTodoStatisticsUseCase getTodoStatisticsUseCase(Ref ref) {
  return GetTodoStatisticsUseCase(ref.watch(todosRepositoryProvider));
}

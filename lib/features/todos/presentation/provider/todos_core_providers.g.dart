...
part of 'todos_core_providers.dart';
...
String _$getTodoStatisticsUseCaseHash() =>
    r'9e46e9e2bc68535be6bca47131d9e7c25e98ac69';

/// See also [getTodoStatisticsUseCase].
@ProviderFor(getTodoStatisticsUseCase)
final getTodoStatisticsUseCaseProvider =
    Provider<GetTodoStatisticsUseCase>.internal(
  getTodoStatisticsUseCase,
  name: r'getTodoStatisticsUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$getTodoStatisticsUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef GetTodoStatisticsUseCaseRef = ProviderRef<GetTodoStatisticsUseCase>;
